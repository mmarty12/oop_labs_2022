...
MatrixCreate& matrixCreate = matrixCreate.getInstance();
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_COPYDATA:
        SetWindowPos(hWnd, NULL, 540, 40, 600, 500, SWP_SHOWWINDOW);
        matrixCreate.OnCopyData(hWnd, wParam, lParam);
        break;
    case WM_COMMAND:
        {
