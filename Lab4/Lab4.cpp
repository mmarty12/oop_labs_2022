    ...
    case WM_COMMAND:
        {
            ...
            case ID_POINT:
                ...
                ED.Start(hWnd, new PointShape); //початок вводу точкових об’єктів
                break;
            case ID_TOOL_LINE:
            case ID_LINE:
                ToolBar.OnPressBtn(hWnd, ID_TOOL_LINE);
                ED.Start(hWnd, new LineShape); //початок вводу об’єктів-ліній
                break;
            case ID_TOOL_REC:
            case ID_REC:
                ToolBar.OnPressBtn(hWnd, ID_TOOL_REC);
                ED.Start(hWnd, new RecShape); //початок вводу вводу прямокутників
                break;
            case ID_TOOL_ELLIPSE:
            case ID_ELLIPSE:
                ToolBar.OnPressBtn(hWnd, ID_TOOL_ELLIPSE);
                ED.Start(hWnd, new EllipseShape); //початок вводу еліпсів
                break;
            case ID_TOOL_CUBE:
            case ID_CUBE:
                ToolBar.OnPressBtn(hWnd, ID_TOOL_CUBE);
                ED.Start(hWnd, new CubeShape); //початок вводу еліпсів
                break;
            case ID_TOOL_LINEOO:
            case ID_LINEOO:
                ToolBar.OnPressBtn(hWnd, ID_TOOL_LINEOO);
                ED.Start(hWnd, new LineOOShape); //початок вводу еліпсів
                break;
            case IDM_ABOUT:
