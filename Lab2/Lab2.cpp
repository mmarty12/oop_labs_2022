...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITMENUPOPUP: //позначка пунктів меню - для окремих варіантів завдань
        Redactor.OnInitMenuPopup(hWnd, wParam);
        break;
    ...
    case WM_COMMAND:
        {
            ...
            {
            case ID_POINT:
                Redactor.StartPointEditor(); //початок вводу точкових об’єктів
                break;
            case ID_LINE:
                Redactor.StartLineEditor(); //початок вводу об’єктів-ліній
                break;
            case ID_REC:
                Redactor.StartRecEditor(); //початок вводу вводу прямокутників
                break;
            case ID_ELLIPSE:
                Redactor.StartEllipseEditor(); //початок вводу еліпсів
                break;
            case IDM_ABOUT:
